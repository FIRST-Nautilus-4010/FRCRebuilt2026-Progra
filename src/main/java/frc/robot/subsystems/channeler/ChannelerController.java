...
/**
 * Encapsula la configuración y el control del channeler:
 * <ul>
 ...
 * Esta clase:
 * <ul>
 *   <li>Aplica las ganancias de los slots desde {@link ChannelerConstants}</li>
 ...
 * </ul>
 */
public class ChannelerController {
     ...
     * <p>
     * Valores tomados de {@link ChannelerConstants}:
     * kS, kV, kA, kP, kI, kD.
     */
    private void configureSpinGains() {
        var slot0 = spinConfig.Slot0;
        slot0.kS = ChannelerConstants.VEL_KS;
        slot0.kV = ChannelerConstants.VEL_KV;
        slot0.kA = ChannelerConstants.VEL_KA;
        slot0.kP = ChannelerConstants.VEL_KP;
        slot0.kI = ChannelerConstants.VEL_KI;
        slot0.kD = ChannelerConstants.VEL_KD;
    }
    ...
    private void configureMotionMagic() {
        ...
        spinMM.MotionMagicAcceleration = ChannelerConstants.MAGIC_MOTION_VELOCITY_ACCELERATION_STR;
        spinMM.MotionMagicJerk = ChannelerConstants.MAGIC_MOTION_VELOCITY_JERK_STR;
    }
    ...
    /**
     * Establece la velocidad lineal deseada del channeler.
     *
